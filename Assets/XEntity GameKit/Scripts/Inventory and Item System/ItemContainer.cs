...
namespace XEntity.InventoryItemSystem
{
    ...
    public class ItemContainer : MonoBehaviour
    {
        ...
        protected void IntialzieMainUI(Transform containerPanel)
        {
            ...
            {
                containerPanel = this.transform; // Eðer dýþarýdan null geldiyse kendi transformunu kullan
            }
        ...
        protected void ToggleUI()
        {
            ...
            // 1) Gerçek duruma göre senkronize et
            bool currentlyActive = mainContainerUI.gameObject.activeSelf;

            // 2) Bir sonraki hedef durumu belirle
            bool nextState = !currentlyActive;
            isContainerUIOpen = nextState;
            ...
            {
                // Kapat (false parametresi kapatýnca SetActive(false) yapar)
